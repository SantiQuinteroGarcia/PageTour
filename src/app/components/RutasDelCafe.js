...
class RutasDelCafe extends Component {
        ...
        return (
            <div>
                <div className="jumbotron bg-primary text-light font-weight-bolder">
                    ...
                    <p className="lead">Pagetour quiere conectarte con las rutas del café, símbolo nacional.</p>
                ...
                <div className="container bg-primary p-5">
                    <h2 className="text-center text-white mb-5 font-weight-bold">Rutas del Café</h2>
